...
| 操作 | 文件路径 | 职责 |
|------|----------|------|
| 重写 | `Obsidian Vault/Projects/Universal-Computer-Use-MCP/工程计划.md` | 主工程计划文档 v2.1 |
| 更新 | `Obsidian Vault/Projects/Universal-Computer-Use-MCP/进度跟踪.md` | 同步 Phase 0 完成状态 |
| 更新 | `Obsidian Vault/UCU-MCP项目/进度追踪.md` | 同步最新审计结果 |
...
**Files:**
- Rewrite: `Obsidian Vault/Projects/Universal-Computer-Use-MCP/工程计划.md:1-50`

- [ ] **Step 1: 备份原文件**

```bash
cp "Obsidian Vault/Projects/Universal-Computer-Use-MCP/工程计划.md" \
   "Obsidian Vault/Projects/Universal-Computer-Use-MCP/工程计划-v2-backup.md"
```
...
```bash
head -30 "Obsidian Vault/Projects/Universal-Computer-Use-MCP/工程计划.md"
```
...
**Files:**
- Rewrite: `Obsidian Vault/Projects/Universal-Computer-Use-MCP/工程计划.md:50-175`
...
```bash
grep -n "v2.1" "Obsidian Vault/Projects/Universal-Computer-Use-MCP/工程计划.md"
```
...
**Files:**
- Rewrite: `Obsidian Vault/Projects/Universal-Computer-Use-MCP/工程计划.md:175-290`
...
```bash
grep -c "砍掉" "Obsidian Vault/Projects/Universal-Computer-Use-MCP/工程计划.md"
```
...
**Files:**
- Rewrite: `Obsidian Vault/Projects/Universal-Computer-Use-MCP/工程计划.md:290-end`
...
```bash
wc -l "Obsidian Vault/Projects/Universal-Computer-Use-MCP/工程计划.md"
```
...
**Files:**
- Update: `Obsidian Vault/Projects/Universal-Computer-Use-MCP/进度跟踪.md`
- Update: `Obsidian Vault/UCU-MCP项目/进度追踪.md`
...
```bash
grep -c "v2.1" "Obsidian Vault/Projects/Universal-Computer-Use-MCP/工程计划.md"
```
...
```bash
grep "⬜" "Obsidian Vault/Projects/Universal-Computer-Use-MCP/进度跟踪.md"
```
...
```bash
ls -la "Obsidian Vault/Projects/Universal-Computer-Use-MCP/工程计划-v2-backup.md"
```
